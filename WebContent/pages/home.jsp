...
<body>
	...
	<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
           ...
           <div class="col-md-6 col-md-offset-3" style="margin-top:10px">
                <h2>Tagged documents: <%=completed%>%</h2>
                ...
                <div class="panel panel-default"  style="margin-top:20px">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td style="text-align:center"><a class="fa fa-caret-square-o-right detailsIcon" href="../getNextTaggingByEvaluator?evaluatorId=<%=evaluator.getId()%>"></a></td>
                                        </tr>
                                        <% } %>
                                    </tbody>
                                </table>
                    ...
                    <div class="panel-body">
                        ...
                        action="../insertEvaluator" method="post">
                                ...
                                <div class="row">
                                <button class="btn btn-sm btn-primary col-md-6 col-md-offset-4" type="submit">Add evaluator</button>
                                </div>
                        </form>
                    </div>
